#include "Arduino.h"
#include "Brain.h"
#define btSerial Serial3  //bluetooth serial: Change this to Serial2 or Serial3 depending on the serial pins you chose to connect TX and RX of the blueSMiRF to
